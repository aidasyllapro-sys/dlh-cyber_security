...
CONTROLS_JSON='[
  ...
  {"id":"NET-SURICATA-01","platform":"network","family":"network","description":"The custom Suricata rule file must be loaded with at least six rules","check_type":"command_exit_zero","check_target":"[ \"$(grep -cE \"^(alert|pass)[[:space:]]\" meddefense.rules)\" -ge 6 ]","expected_value":"exit 0","source_project":"2x04","severity":"high"},
